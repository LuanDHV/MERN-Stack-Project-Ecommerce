...
export default function SalePage() {
  ...
  const displayedProducts = products
    .filter((product) =>
      product.categories.includes("65c600cbfb866364b3105e45")
    )
  ...
  return (
    <>
      <section>
        ...
        <div className="">
          <img
            src="https://file.hstatic.net/200000182297/file/banner-web_ct_8-3_nem_1920x500_c3ceafff7fb14e12b0761f7833c4226f.jpg"
            alt=""
                        ...
                        <div className="hover:-translate-y-1 duration-500 ease-in-out">
                          <div className="w-[321px] h-[481px] relative group overflow-hidden">
                            <div className="relative">
                              <div
                                className="w-[60px] h-[30px] bg-white border rounded-full 
                              text-center text-[12px] text-red-600 leading-[30px]  
