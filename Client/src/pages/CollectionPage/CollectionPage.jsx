...
export default function CollectionPage() {
  return (
    <>
      <section>
        <div className="mx-auto mt-24 h-auto w-full border-t border-[#EFEFF4]">
      ...
      <section>
        <div className="mx-auto mt-10 grid h-auto w-[1300px] grid-flow-col">
          <div className="grid h-auto w-[800px] grid-flow-row">
            <div className="grid h-auto grid-cols-2">
              <div className="w-[371px]">
                <div className="duration-500 ease-in-out hover:-translate-y-1">
                  <div className="group relative h-auto w-[371px] overflow-hidden rounded-md">
                    <div className="">
                      <img
                        src="https://product.hstatic.net/200000182297/product/4_20ac203e48fb4464b82ee87b41571b62_1024x1024.jpg"
                        alt=""
                        className="h-full w-full rounded-md object-cover hover:opacity-90"
                      />
                    </div>
                    <div className="absolute inset-0 flex items-center justify-center bg-[#212529] opacity-0 transition-opacity hover:opacity-10"></div>
                  </div>
            ...
            <div className="mt-10 h-auto w-[750px]">
              ...
              <button className="mb-[20px] h-10 w-[340px] rounded border border-black bg-[#f8f8f9] duration-500 ease-in-out hover:bg-[#070707] hover:text-white">
                <p className="font-bold">XEM THÊM</p>
              </button>
            </div>
          </div>
          <div className="grid h-auto w-full grid-rows-1 pl-[20px]">
            <div className="grid h-auto w-[480px] grid-flow-row">
              <img
        ...
        <div className="mx-auto my-[100px] h-[0.8px] w-[760px] border border-[#e7e7e7]">
          <hr className=""></hr>
        </div>
        ...
        <div className="mx-auto mt-10 grid h-auto w-[1300px] grid-flow-col">
          <div className="grid h-auto w-full grid-rows-1">
            <div className="grid h-auto w-[480px] grid-flow-row">
              <img
          ...
          <div className="grid h-auto w-[800px] grid-flow-row">
            ...
            <div className="mt-10 h-auto w-[750px]">
              ...
              <button className="float-end mb-[20px] h-10 w-[340px] rounded border border-black bg-[#f8f8f9] duration-500 ease-in-out hover:bg-[#070707] hover:text-white">
                <p className="font-bold">XEM THÊM</p>
              </button>
            </div>
          </div>
