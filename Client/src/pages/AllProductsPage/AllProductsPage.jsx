...
export default function AllProductsPage() {
  ...
  const totalPages = Math.ceil(products.length / productsPerPage); // Tính toán số trang
  ...
  return (
    <>
      <section>
        ...
        <div className="">
          <img
            src="https://theme.hstatic.net/200000182297/1000887316/14/ms_banner_img3.jpg?v=1114"
            alt=""
